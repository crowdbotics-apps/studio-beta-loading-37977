...
## Project Structure
    ...
    ├── studio_beta_loading_37977  # Django project configurations
...
1. Clone this repo and `cd studio_beta_loading_37977`
...
2. Clone this repo and `cd studio_beta_loading_37977`
